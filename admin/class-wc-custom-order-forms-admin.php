...
class Wc_Custom_Order_Forms_Admin {
	...
	public function wc_order_form_buy()
	{
		...
		$form_buy .= '<input class="form-control" type="text" name="name" value="'.$name.'" required/>';
		$form_buy .= '</div>';
		$form_buy .= '<div class="form-group">';
		$form_buy .= '<label label-for="contact_number">Contact Number: </label>';
		$form_buy .= '<input class="form-control" type="text" name="contact_number" value="'.$phone.'" required/>';
		$form_buy .= '</div>';
		$form_buy .= '<div class="form-group">';
		$form_buy .= '<label label-for="email_address">Email Address: </label>';
		$form_buy .= '<input class="form-control" type="text" name="email_address" value="'.$email.'" required/>';
		$form_buy .= '</div>';
		$form_buy .= '</div>';
		$form_buy .= '<div class="tabs">';	
	...
	public function wc_order_form_ship()
	{
		...
		$form_ship .= '<input class="form-control" type="text" name="name" value="'.$name.'" required/>';
		$form_ship .= '</div>';
		$form_ship .= '<div class="form-group">';
		$form_ship .= '<label label-for="contact_number">Contact Number: </label>';
		$form_ship .= '<input class="form-control" type="text" name="contact_number" value="'.$phone.'" required/>';
		$form_ship .= '</div>';
		$form_ship .= '<div class="form-group">';		
		$form_ship .= '<label label-for="email_address">Email Address: </label>';
		$form_ship .= '<input class="form-control" type="text" name="email_address" value="'.$email.'" required/>';
		$form_ship .= '</div>';
		$form_ship .= '</div>';
		$form_ship .= '<div class="tabs">';
